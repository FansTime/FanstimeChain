...
/**
	...
	A com.blockchain.bsh.This object is a thin layer over a NameSpace that associates it with
	...
	NameSource
{
	...
	*/
	...
	/**
		...
		primitive values you will have to wrap them using com.blockchain.bsh.Primitive.
		@see Primitive
		<p>
	...
	*/
	...
	/**
		...
		Note: this method should probably return type com.blockchain.bsh.This to be consistent
		with getThis();
	*/
...
// this?
	...
	*/
	...
	/**
		...
		e.g. importCommands("/bsh/commands") or importCommands("com.blockchain.bsh.commands")
	...
	*/
	...
	/**
		...
		<pre>
			importClass("com.blockchain.bsh.EvalError");
			importClass("com.blockchain.bsh.Interpreter");
