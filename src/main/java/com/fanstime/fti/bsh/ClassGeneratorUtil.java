...
import com.fanstime.fti.bsh.asm.*;
...
public class ClassGeneratorUtil implements Constants
{
	...
	*/
	...
	/**
		Translate com.blockchain.bsh.Modifiers into ASM modifier bitflags.
	*/
	...
	*/
	...
	/**
		...
		(wrapping primitive types in com.blockchain.bsh.Primitive), invokes the static or
	...
	*/
	...
	/**
		...
		corresponding to the "new Object[] { new com.blockchain.bsh.Primitive(i), s }"
		expression.
		...
		String [] paramTypes, boolean isStatic, final CodeVisitor cv )
	{
		...
		for (int i = 0; i < paramTypes.length; ++i)
		{
			...
			if ( isPrimitive( param ) )
			{
				...
				// as com.blockchain.bsh.Primitive.NULL.  However the This.invokeMethod()
