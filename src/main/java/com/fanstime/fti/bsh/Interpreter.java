...
/**
	...
	<p><blockquote><pre>
		...
		bsh.source("myscript.bsh");  // or com.blockchain.bsh.eval("source(\"myscript.bsh\")");
	...
	implements Runnable, ConsoleInterface,Serializable
{
	...
	*/
	...
	/** Shared system object visible under com.blockchain.bsh.system */
	...
	*/
    public Interpreter()
    {
        ...
        evalOnly = true;
		setu( "com.blockchain.bsh.evalOnly", Primitive.TRUE );
    }
	...
	*/
	public void setConsole( ConsoleInterface console ) {
		...
		setu( "com.blockchain.bsh.console", console );
	...
	private void initRootSystemObject() 
	{
		...
		// com.blockchain.bsh.system
		setu( "com.blockchain.bsh.system", sharedObject );
		setu( "com.blockchain.bsh.shared", sharedObject ); // alias

		// com.blockchain.bsh.help
		This helpText = new NameSpace( 
			bcm, "Bsh Command Help Text" ).getThis( this );
		setu( "com.blockchain.bsh.help", helpText );

		// com.blockchain.bsh.cwd
		try {
			setu( "com.blockchain.bsh.cwd", System.getProperty("user.dir") );
		} catch ( SecurityException e ) { 
			// applets can't see sys props
			setu( "com.blockchain.bsh.cwd", "." );
		}

		// com.blockchain.bsh.interactive
		setu( "com.blockchain.bsh.interactive", interactive ? Primitive.TRUE : Primitive.FALSE );
		// com.blockchain.bsh.evalOnly
		setu( "com.blockchain.bsh.evalOnly", evalOnly ? Primitive.TRUE : Primitive.FALSE );
	}
	...
	*/
    public static void main( String [] args ) 
	{
        if ( args.length > 0 ) {
			...
			interpreter.setu( "com.blockchain.bsh.args", bshArgs );
			try {
				Object result = 
	...
	*/
	...
	/**
		Localize a path to the file name based on the com.blockchain.bsh.cwd interpreter 
		working directory.
	*/
		...
		throws IOException
	{
		...
		// if relative, fix up to com.blockchain.bsh.cwd
		if ( !file.isAbsolute() ) {
			String cwd = (String)getu("com.blockchain.bsh.cwd");
