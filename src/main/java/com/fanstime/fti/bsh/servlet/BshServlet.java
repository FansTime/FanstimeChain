 ...
 *                                                                           *
 *****************************************************************************/
package com.fanstime.fti.bsh.servlet;
...
public class BshServlet extends HttpServlet 
{
	...
	static String getBshVersion() 
	{
		...
		/*
			...
			of com.blockchain.bsh.  If bsh is packaged in the WAR file it could access it
	...
	{
		String script = request.getParameter("com.blockchain.bsh.script");
		String client = request.getParameter("com.blockchain.bsh.client");
		String output = request.getParameter("com.blockchain.bsh.servlet.output");
		String captureOutErr = 
			request.getParameter("com.blockchain.bsh.servlet.captureOutErr");
	...
	*/
		...
		throws EvalError
	{
		...
		// set up interpreter
		bsh.set( "com.blockchain.bsh.httpServletRequest", request );
		bsh.set( "com.blockchain.bsh.httpServletResponse", response );
