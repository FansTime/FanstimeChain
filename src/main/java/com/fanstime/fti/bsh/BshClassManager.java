...
/*
	...
	implementation (the optional com.blockchain.bsh.classpath package) to accommodate all of
	...
	*/
	public static BshClassManager createClassManager( Interpreter interpreter ) 
	{
		...
		if ( Capabilities.classExists("java.lang.ref.WeakReference") 
			...
			&& Capabilities.classExists("com.blockchain.bsh.classpath.ClassManagerImpl") 
		) 
			try {
				// Try to load the module
				// don't refer to it directly here or we're dependent upon it
				Class clas = Class.forName("com.fanstime.fti.bsh.classpath.ClassManagerImpl");
	...
	/**
		...
		See com.blockchain.bsh.classpath.ClassManagerImpl for the fully functional class
		management package.
	...
	*/
		...
		throws ClassNotFoundException
	{
		...
		/*
			...
			e.g. com.blockchain.bsh.console com.blockchain.bsh.Console
