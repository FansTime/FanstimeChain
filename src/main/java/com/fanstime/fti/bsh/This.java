...
public class This implements java.io.Serializable, Runnable 
{
	...
	*/
	...
	/**
		...
		e.g. interface proxy or event call backs from outside of com.blockchain.bsh.
	*/
	transient Interpreter declaringInterpreter;

	/**
		getThis() is a factory for com.blockchain.bsh.This type references.  The capabilities
		...
		NameSpace namespace, Interpreter declaringInterpreter ) 
	{
		try {
			...
			if ( Capabilities.canGenerateInterfaces() )
				c = Class.forName("com.fanstime.fti.bsh.XThis");
			else if ( Capabilities.haveSwing() )
				c = Class.forName("com.fanstime.fti.bsh.JThis");
			else
	...
	*/
	...
	/**
		...
		@see This#invokeMethod(String, Object[], Interpreter, CallStack, SimpleNode, boolean)
	...
	*/
	...
	/**
		...
		Don't give com.blockchain.bsh.This a chance to override their behavior.
		<p>

		If the method is passed here the invocation will actually happen on
		the com.blockchain.bsh.This object via the regular reflective method invocation 
		mechanism.  If not, then the method is evaluated by com.blockchain.bsh.This itself
