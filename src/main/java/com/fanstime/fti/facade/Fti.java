...
public interface Fti {
    ...
    void addListener(FtiListener listener);
     ...
     * @param value - the fti value of the transaction
     ...
     * and decoded with {@link com.fanstime.fti.core.CallTransaction.Function#decodeResult(byte[])}.
     */
...
//  2.   // is blockchain still loading - if buffer is not empty
     ...
     * like Fti MainNet. But it's light and simple and still could be used for test networks. If you
     * want to get accurate recommended gas price use {@link com.fanstime.fti.listener.RecommendedGasPriceTracker}
     ...
     * @return Future, which completes when syncDone is turned to True in {@link com.fanstime.fti.sync.SyncManager}
     */
