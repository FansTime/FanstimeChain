 ...
 *
 * Created by Jay Nicolas on 10.06.2018.
 */
@Component
public class BlockMiner {
    ...
    private CompositeFtiListener listener;
    ...
    @Autowired
    public BlockMiner(final SystemProperties config, final CompositeFtiListener listener,
    ...
    protected void blockMined(Block newBlock) throws InterruptedException {
        ...
        ImportResult importResult = ((FtiImpl) fti).addNewMinedBlock(newBlock);
