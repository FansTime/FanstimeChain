...
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.DATASET_READY;
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.DATASET_PREPARE;
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.FULL_DATASET_GENERATED;
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.FULL_DATASET_GENERATE_START;
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.FULL_DATASET_LOADED;
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.FULL_DATASET_LOAD_START;
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.LIGHT_DATASET_GENERATED;
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.LIGHT_DATASET_GENERATE_START;
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.LIGHT_DATASET_LOADED;
import static com.fanstime.fti.mine.EthashListener.DatasetStatus.LIGHT_DATASET_LOAD_START;
import static com.fanstime.fti.util.ByteUtil.longToBytes;
import static com.fanstime.fti.mine.MinerIfc.MiningResult;

/**
 * More high level validator/miner class which keeps a cache for the last requested block epoch
 *
 * Created by Jay Nicolas on 04.06.2018.
 */
public class Ethash {
