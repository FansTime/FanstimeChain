...
import com.fanstime.fti.db.*;
import com.fanstime.fti.trie.Trie;
import com.fanstime.fti.trie.TrieImpl;
...
import com.fanstime.fti.validator.DependentBlockHeaderRule;
import com.fanstime.fti.validator.ParentBlockHeaderValidator;
...
import static com.fanstime.fti.core.Denomination.SZABO;
import static com.fanstime.fti.core.ImportResult.*;
import static com.fanstime.fti.crypto.HashUtil.sha3;
import static com.fanstime.fti.util.ByteUtil.toHexString;

/**
 * The Fti blockchain is in many ways similar to the Bitcoin blockchain,
 * although it does have some differences.
 * <p>
 * The main difference between Fti and Bitcoin with regard to the blockchain architecture
 * is that, unlike Bitcoin, Fti blocks contain a copy of both the transaction list
 ...
 * </p>
 * The block validation algorithm in Fti is as follows:
 * <ol>
 ...
 * <li>Check that the block number, difficulty, transaction root, uncle root and gas limit (various low-level Fti-specific concepts) are valid.</li>
 ...
 */
@Component
public class BlockchainImpl implements Blockchain, com.fanstime.fti.facade.Blockchain {
    ...
    public BlockchainImpl(final BlockStore blockStore, final Repository repository) {
        ...
        this.listener = new FtiListenerAdapter();
    ...
    public BlockchainImpl withFtiListener(FtiListener listener) {
