...
import static com.fanstime.fti.datasource.MemSizeEstimator.ByteArrayEstimator;
import static com.fanstime.fti.util.ByteUtil.EMPTY_BYTE_ARRAY;
import static com.fanstime.fti.util.ByteUtil.ZERO_BYTE_ARRAY;
...
import com.fanstime.fti.crypto.ECKey.ECDSASignature;
import com.fanstime.fti.crypto.ECKey.MissingPrivateKeyException;
import com.fanstime.fti.crypto.HashUtil;
import com.fanstime.fti.datasource.MemSizeEstimator;
import com.fanstime.fti.util.ByteUtil;
import com.fanstime.fti.util.RLP;
import com.fanstime.fti.util.RLPElement;
import com.fanstime.fti.util.RLPItem;
 ...
 * signed instruction sent by an actor external to Fti.
...
public class Transaction {
    ...
    /* the amount of fti to transfer (calculated as wei) */
    private byte[] value;
    ...
    /* the amount of fti to pay as a transaction fee
    ...
    public synchronized void rlpParse() {
        ...
        try {
            ...
            if (new String(this.data).startsWith("//!java"))
                this.languageType = 1;  // FIXME: an ugly check here, but pending transactions must be from RLP...
    ...
    public int getLanguage() { return languageType; }
    public void setLanguage(int t) { languageType = t; }
