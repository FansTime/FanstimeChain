...
import com.fanstime.fti.config.NodeFilter;
...
import static com.fanstime.fti.core.connect.message.ReasonCode.DUPLICATE_PEER;
import static com.fanstime.fti.core.connect.message.ReasonCode.TOO_MANY_PEERS;
