...
import static com.fanstime.fti.listener.FtiListener.PendingTransactionState.DROPPED;
import static com.fanstime.fti.listener.FtiListener.PendingTransactionState.INCLUDED;
import static com.fanstime.fti.listener.FtiListener.PendingTransactionState.NEW_PENDING;
import static com.fanstime.fti.listener.FtiListener.PendingTransactionState.PENDING;
...
import com.fanstime.fti.listener.FtiListener.PendingTransactionState;
...
//    private Repository repository;
    ...
    @Autowired
    public PendingStateImpl(final FtiListener listener) {
...
//        this.repository = blockchain.getRepository();
    ...
    private boolean addPendingTransactionImpl(final Transaction tx) {
        ...
        if (err != null) {
            System.out.println("********** [PendingStateImpl::addPendingTransactionImpl] " + err);
    ...
    private TransactionReceipt executeTx(Transaction tx) {
        ...
        TransactionExecutor executor = new TransactionExecutor(
                ...
                blockStore, programInvokeFactory, createFakePendingBlock(), new FtiListenerAdapter(), 0)
