...
import com.fanstime.fti.crypto.jce.ECKeyAgreement;
import com.fanstime.fti.crypto.jce.ECKeyFactory;
import com.fanstime.fti.crypto.jce.ECKeyPairGenerator;
import com.fanstime.fti.crypto.jce.ECSignatureFactory;
import com.fanstime.fti.crypto.jce.SpongyCastleProvider;
...
import static com.fanstime.fti.util.BIUtil.isLessThan;
import static com.fanstime.fti.util.ByteUtil.bigIntegerToBytes;
 ...
 *
 * This code is borrowed from the bitcoinj project and altered to fit Fti.<br>
...
public class ECKey implements Serializable {
    ...
    /**
     * The parameters of the secp256k1 curve that Fti uses.
     */
    ...
    static {
        // All clients must agree on the curve to use by agreement. Fti uses secp256k1.
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the Fti protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * the same message. However, we dislike the ability to modify the bits of a Fti transaction after it's
     ...
     * @param signatureBase64 The Fti-format message signature in base64
     *
     * @return -
