...
import com.fanstime.fti.web.service.ClientMessageService;
import com.fanstime.fti.web.service.ClientMessageServiceDummy;
import com.fanstime.fti.web.service.ClientMessageServiceImpl;
import com.fanstime.fti.web.service.contracts.ContractsService;
import com.fanstime.fti.web.service.contracts.ContractsServiceImpl;
import com.fanstime.fti.web.service.contracts.DisabledContractService;
import com.fanstime.fti.util.exception.Web3jSafeAnnotationsErrorResolver;
...
public class ModuleConfig {
    ...
    private ChainProperties props = ChainProperties.DEFAULT;
    ...
    public Filter modulePortFilter() {
        if (secondPort != null) {
            return new ModulePortFilter(ChainProperties.DEFAULT.rpcPort(), ChainProperties.DEFAULT.webPort());
        } else {
