 ...
 * RLP is the main encoding method used to serialize objects in Fti. The
 ...
 * Fti the standard is that integers are represented in big endian binary
...
public class RLP {
    ...
    public static int decodeInt(byte[] data, int index) {
        ...
        int value = 0;
        // NOTE: From RLP doc:
        // Fti integers must be represented in big endian binary form
