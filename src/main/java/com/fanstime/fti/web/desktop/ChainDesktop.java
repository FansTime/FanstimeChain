...
import com.fanstime.fti.web.Application;
...
public class ChainDesktop {

    private static String LOGS_PATH = System.getProperty("user.home") + "/fti/fanstime-logs";
    ...
    static {
        ...
        System.setProperty("database.dir", System.getProperty("user.home") + "/fti/database");
    }
    ...
    private void start() throws Exception {
        ...
        final TrayIcon trayIcon = new TrayIcon(new ImageIcon(imageDisabledUrl).getImage(), "Fti Chain");
...
//        Runtime.getRuntime().addShutdownHook(new Thread(() -> closeContext()));
        ...
        executor.submit(() -> {
            try {
                ...
                showErrorWindow(cause.getMessage(), "Problem running blockchain:\n\n"
...
//            System.setProperty("apple.awt.UIElement", "false");
            ...
            JOptionPane.showMessageDialog(frame, panel, "Oops. Fti stopped with error.",
