...
import com.fanstime.fti.web.model.dto.WalletAddressDTO;
import com.fanstime.fti.web.model.dto.WalletConfirmTransactionDTO;
import com.fanstime.fti.web.model.dto.WalletInfoDTO;
import com.fanstime.fti.web.keystore.Keystore;
import com.fanstime.fti.web.model.Account;
import com.fanstime.fti.web.service.wallet.FileSystemWalletStore;
import com.fanstime.fti.web.service.wallet.WalletAddressItem;
 ...
 *      a) default fti keystore folder in filesystem;
 ...
 *
 * Created by Bynum Williams on 24.08.16.
 */
@Service
...
public class WalletService {
    ...
    public void init() {
        ...
        // workaround issue in Fti-core, where single miner could never got sync done event
    ...
    public WalletInfoDTO getWalletInfo() {
        BigInteger gasPrice = BigInteger.valueOf(fti.getGasPrice());
