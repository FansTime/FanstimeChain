...
import com.fanstime.fti.web.contrdata.ContractDataService;
import com.fanstime.fti.web.contrdata.contract.Ast;
import com.fanstime.fti.web.contrdata.contract.ContractData;
import com.fanstime.fti.web.contrdata.storage.Path;
import com.fanstime.fti.web.contrdata.storage.Storage;
import com.fanstime.fti.web.contrdata.storage.StorageEntry;
import com.fanstime.fti.web.contrdata.storage.StoragePage;
import com.fanstime.fti.web.contrdata.storage.dictionary.Layout;
import com.fanstime.fti.web.contrdata.storage.dictionary.StorageDictionary;
import com.fanstime.fti.web.contrdata.storage.dictionary.StorageDictionaryDb;
import com.fanstime.fti.web.contrdata.storage.dictionary.StorageDictionaryVmHook;
import com.fanstime.fti.config.ChainProperties;
import com.fanstime.fti.web.service.BlockchainConsts;
import com.fanstime.fti.util.SolcUtils;
import com.fanstime.fti.util.TrustSSL;
import com.fanstime.fti.util.exception.ContractException;
...
import static com.fanstime.fti.util.StreamUtil.streamOf;
...
import static com.fanstime.fti.util.exception.ContractException.compilationError;
import static com.fanstime.fti.util.exception.ContractException.validationError;
 ...
 *
 * Created by Bynum Williams on 17.10.16.
 */
...
public class ContractsServiceImpl implements ContractsService {
    ...
    private String getValidatedAbi(String address, String contractName, CompilationResult result) {
        ...
        final String code = toHexString(fti.getRepository().getCode(Hex.decode(address)));
...
//        String beforeJumpDest = substringBefore(asm, "JUMPDEST");
    ...
    private ContractInfoDTO compileAndSave(String hexAddress, List<String> files) {
        ...
        final byte[] codeBytes = fti.getRepository().getCode(address);
