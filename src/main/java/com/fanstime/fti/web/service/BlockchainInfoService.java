...
import com.fanstime.fti.web.keystore.FileSystemKeystore;
import com.fanstime.fti.util.BlockUtils;
import com.fanstime.fti.listener.RecommendedGasPriceTracker;
import com.fanstime.fti.util.BuildInfo;
import org.slf4j.LoggerFactory;
import ch.qos.logback.classic.Logger;
import com.fanstime.fti.web.model.dto.*;
...
public class BlockchainInfoService implements ApplicationListener {
    ...
    private void postConstruct() {
        ...
        fti.addListener(gasPriceTracker);
    ...
    public void onApplicationEvent(ApplicationEvent event) {
        if (event instanceof EmbeddedServletContainerInitializedEvent) {
            ...
            System.out.println("Database dir location: " + systemProperties.databaseDir());
            System.out.println("Keystore dir location: " + keystore.getKeyStoreLocation());
    ...
    private void doUpdateBlockchainStatus() {
        ...
        final Block bestBlock = fti.getBlockchain().getBestBlock();
    ...
    /**
     * Created by Bynum Williams on 09.08.16.
     */
