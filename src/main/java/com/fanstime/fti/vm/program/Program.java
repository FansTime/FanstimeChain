...
import com.fanstime.fti.vm.PrecompiledContracts.PrecompiledContract;
...
import com.fanstime.fti.vm.program.listener.CompositeProgramListener;
import com.fanstime.fti.vm.program.listener.ProgramListenerAware;
import com.fanstime.fti.vm.program.listener.ProgramStorageChangeListener;
import com.fanstime.fti.vm.trace.ProgramTraceListener;
import com.fanstime.fti.vm.trace.ProgramTrace;
...
public class Program {
     ...
     * fti may need to be started with a JVM argument to increase
    ...
    public DataWord storageLoad(byte[] key) {
        DataWord keyWord = new DataWord(key);
        DataWord ret = getStorage().getStorageValue(getOwnerAddress().getLast20Bytes(), keyWord.clone());
        return ret == null ? null : ret.clone();
    }
    ...
    /**
     * Denotes problem when executing Fti bytecode.
